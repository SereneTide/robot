...
CUBE_POS_LIST = [
    ...
    # ====== 中层 (z=0.09): 2个，两墙之间，y轴两侧夹缝，迫使Z向绕行 ======
    (0.52, -0.06, 0.09),  # y负侧，堵住Wall2缺口的正上方
    (0.52,  0.06, 0.09),  # y正侧，堵住Wall1缺口的正上方
    # ====== 上层 (z=0.12): 2个，偏向Wall2方向，迫使路径抬高绕行 ======
    (0.55, -0.06, 0.12),
    (0.55,  0.06, 0.12),
]
CUBE_COLORS = (
    [(0.75, 0.25, 0.25, 1.0)] * 4 +    # 底层：红系
    [(1.00, 0.65, 0.00, 1.0)] * 2 +    # 中层：橙系
    [(0.25, 0.65, 0.25, 1.0)] * 2      # 上层：绿系
)
